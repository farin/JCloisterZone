...
#   CATAPULT, KING_AND_SCOUT, RIVER, RIVER_II, CATHARS, BESIEGERS, COUNT, GQ11, CULT, TUNNEL, CORN_CIRCLES, PLAGUE, FESTIVAL, PHANTOM, WIND_ROSE,
#   FLIER, CORN_CIRCLES_II
# possible rules:
#   TINY_CITY_2_POINTS, FARM_CITY_SCORED_ONCE, CANNOT_PLACE_BUILDER_ON_VOLCANO, PRINCESS_MUST_REMOVE_KNIGHT, ESCAPE_RGG, PIG_HERD_ON_GQ_FARM, MULTI_BARN_ALLOWEDD
#   TUNNELIZE_ALL_EXPANSIONS,  BAZAAR_NO_AUCTION
