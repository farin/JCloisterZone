...
public class FigureTheme extends Theme {
    ...
    //@Deprecated split to tokens and neutral figures
    public Image getNeutralImage(String name) {
        return getLayeredImage("neutral/" + name, null);
    }

    public Image getNeutralImage(NeutralFigure nf) {
        return getNeutralImage(nf.getClass());
    }

    public Image getNeutralImage(Class<? extends NeutralFigure> type) {
        return getLayeredImage("neutral/" + type.getSimpleName().toLowerCase(), null);
    }
