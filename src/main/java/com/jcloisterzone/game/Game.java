...
public class Game extends GameSettings {
	...
	/** index of active player in plist */
	protected int turnPlayer; //player in turn
...
//	}
	...
	public void setNextPlayer() {
		turnPlayer =
			turnPlayer == (plist.length - 1) ? 0 : turnPlayer + 1;
		fireGameEvent().playerActivated(getTurnPlayer(), getTurnPlayer());
	}
